package com.show.qixin.api.common.config.web.plugin;
...
import com.show.qixin.api.common.config.web.plugin.annotation.ApiJsonResult;
...
import static com.show.qixin.api.common.config.web.plugin.CommonData.*;
    ...
    public ModelCache addModel(ApiJsonObject jsonObj) {
        ...
        knownModels.put(modelName,
                new Model(modelName,
                        ...
                        "com.show.qixin.api.common.config.web.plugin.CommonData",
